...
async def generate_cover(requested_by, title, views, duration, thumbnail):
    ...
    img = Image.open("etc/NoinoiMusicSq.png")
    ...
    # fonts
    font1 = ImageFont.truetype(r'etc/NoinoiMusic.otf', 30)
    font2 = ImageFont.truetype(r'etc/NoinoiMusic.otf', 60)
    font3 = ImageFont.truetype(r'etc/NoinoiMusic.otf', 49)
...
async def play(_, message: Message):
    ...
    [
       ...
       [
            ...
            InlineKeyboardButton("⭐Update", url="http://t.me/OFFICIALNOINOI"),
        ],
    ]
)
    ...
    if await is_active_chat(message.chat.id):
        ...
        await message.reply_photo(
            ...
            caption="**[Get Additional Information 💡]({})**\n\n**⑆ User :** **{}**\n**⑆ Group : [{}..](https://t.me/NoinoiMusic)**".format(
        ...
        await message.reply_photo(
            photo="final.png",
            reply_markup=keyboard,
            caption="**[Get Additional Information 💡]({})**\n\n**⑆ User :** **{}**\n**⑆ Group : [{}..](https://t.me/OfficialNoinoi)**".format(
                url, message.from_user.mention(), message.chat.title
            ),
        )
