...
from NoinoiMusic.tgcalls import calls, queues
from NoinoiMusic.tgcalls.youtube import download
from NoinoiMusic.tgcalls import convert as cconvert
from NoinoiMusic.tgcalls.calls import client as ASS_ACC
from NoinoiMusic.database.queue import (
    get_active_chats,
    is_active_chat,
    add_active_chat,
    remove_active_chat,
...
import NoinoiMusic.tgcalls
from NoinoiMusic.tgcalls import youtube
...
from NoinoiMusic.utils.decorators import errors, sudo_users_only
from NoinoiMusic.utils.administrator import adminsOnly
from NoinoiMusic.utils.errors import DurationLimitError
from NoinoiMusic.utils.gets import get_url, get_file_name
from NoinoiMusic.modules.admins import member_permissions


def others_markup(videoid, user_id):
    buttons = [
        [
            InlineKeyboardButton(text="Resume", callback_data=f"resumevc"),
            InlineKeyboardButton(text="Pause", callback_data=f"pausevc"),
            InlineKeyboardButton(text="Skip", callback_data=f"skipvc"),
            InlineKeyboardButton(text="Stop", callback_data=f"stopvc"),
        ],[
...
menu_keyboard = InlineKeyboardMarkup(
    [
        [
            ...
            InlineKeyboardButton("Resume", callback_data="resumevc"),
            InlineKeyboardButton("Pause", callback_data="pausevc"),
            InlineKeyboardButton("Skip", callback_data="skipvc"),
            InlineKeyboardButton("Stop", callback_data="stopvc"),
