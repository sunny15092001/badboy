...
from NoinoiMusic.config import UPSTREAM_REPO, BOT_USERNAME, SUDO_USERS, BOT_NAME
...
async def check(_, message: Message):
    ...
    if update_avail:
        ...
        return
    await msg.edit("Bot is already in up-to-date mode with **[latest version](https://github.com/TeamNoinoi/NoinoiMusic)**", disable_web_page_preview=True)
